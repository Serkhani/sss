    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-[#0B0C15]">
            ...
            <div className="relative z-10 text-center space-y-8 max-w-4xl px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto pt-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                    <FeatureCard
                    ...
                    <FeatureCard
                        ...
                        title="Chat Demo"
                        description="Experience a full on-chain chat application built with Somnia Streams."
                    />
                </div>
                ...
                <div className="pt-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-400 flex flex-col md:flex-row items-center justify-center gap-4">
                    <Button
                        onClick={onEnter}
                        className="h-14 px-8 text-lg bg-indigo-600 hover:bg-indigo-500 text-white rounded-full shadow-[0_0_30px_rgba(99,102,241,0.3)] hover:shadow-[0_0_50px_rgba(99,102,241,0.5)] transition-all duration-300 border border-indigo-400/30"
                    >
                        Enter Studio <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                    <a
                        href="/chat"
                        className="h-14 px-8 text-lg flex items-center justify-center bg-slate-800 hover:bg-slate-700 text-white rounded-full border border-slate-700 transition-all duration-300"
                    >
                        Launch Chat Demo
                    </a>
                </div>
